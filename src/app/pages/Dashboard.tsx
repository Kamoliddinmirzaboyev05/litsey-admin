    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {stats.map((stat) => (
          <div
            key={stat.label}
            className="bg-white dark:bg-[#1f2937] rounded-lg border border-gray-200 dark:border-gray-700 p-6 hover:shadow-md dark:hover:shadow-gray-900 transition-shadow"
          >
            <div className="flex items-center justify-between">
              <div>
                <p className="text-[#64748b] dark:text-gray-400 text-sm">{stat.label}</p>
      ...
      <div className="bg-white dark:bg-[#1f2937] rounded-lg border border-gray-200 dark:border-gray-700 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <button className="flex items-center gap-3 px-4 py-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-[#1f2937] dark:text-gray-100 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
            ...
            {recentNews.map((news) => (
              ...
              >
                <div className="flex-1">
                  <h3 className="text-sm font-medium text-[#1f2937] dark:text-gray-100">
                    {news.title}
                  </h3>
                  <p className="text-xs text-[#64748b] dark:text-gray-400 mt-1">{news.date}</p>
                </div>
